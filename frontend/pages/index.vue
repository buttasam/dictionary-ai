      ...
      <div class="flex flex-col items-center justify-center mx-auto h-screen">
        ...
        <div class="w-full md:w-1/2 lg:w-1/4 p-10 md:p-0">
          ...
          <div class="flex flex-col items-center justify-center mx-auto">
            ...
            <div v-if="translations != null && translations.length == 0"
                 class="
                 w-full flex items-center p-4 mb-4 text-sm text-yellow-800 border border-yellow-300 bg-yellow-50"
                 role="alert">
              ...
              <div>
                <span class="font-medium">Word not found!</span>
              </div>
            </div>
          </div>
        </div>
